...
class ReminderListFragment : BaseFragment() {
    ...
    private val BACKGROUND_LOCATION_PERMISSION_INDEX: Int = 1
    private val LOCATION_PERMISSION_INDEX: Int = 0
    private val REQUEST_FOREGROUND_ONLY_PERMISSIONS_REQUEST_CODE: Int = 2
    private val REQUEST_FOREGROUND_AND_BACKGROUND_PERMISSION_RESULT_CODE: Int = 1
